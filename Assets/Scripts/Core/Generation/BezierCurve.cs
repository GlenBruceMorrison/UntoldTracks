...
public static class BezierCurve
{
    ...
    public static Vector3 Point3D(float t, List<Vector3> controlPoints)
    {
    ...
    public static List<Vector3> PointList3D(
    ...
    public static Vector2 Point2D(float t, List<Vector2> controlPoints)
    {
        int N = controlPoints.Count - 1;
        if (N > 16)
        {
    ...
    public static List<Vector2> PointList2D(
